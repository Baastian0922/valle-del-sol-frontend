...
function Register() {
  ...
  const [esEntidad, setEsEntidad] = useState(false);
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800 p-8 rounded-[2rem] shadow-2xl">
          ...
          <form onSubmit={handleRegisterSubmit} className="space-y-4" noValidate>
            ...
            {esEntidad ? (
              <div className="space-y-3.5 p-4 bg-red-950/10 border border-red-500/10 rounded-2xl animate-in fade-in slide-in-from-top-3 duration-300">
                <p className="text-[9px] text-red-400 font-black uppercase tracking-wider italic flex items-center gap-1.5 mb-1">
                  <AlertCircle size={12} /> Registro de respondedor institucional
                </p>
                ...
                <div className="space-y-1">
                  ...
                  <select
                    ...
                    className="w-full bg-slate-950 border border-slate-800 text-white px-4 py-2 rounded-xl focus:outline-none focus:border-red-600/60 transition-all font-semibold text-xs"
                  >
              ...
              /* Campo Nombre (Solo para Vecino/Usuario normal) */
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-400 uppercase tracking-widest ml-1">
                {esEntidad ? 'Correo Institución' : 'Correo Electrónico'}
              </label>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center text-slate-500 group-focus-within:text-red-500 transition-colors pointer-events-none">
                  <Mail size={18} />
                ...
                <input
                  ...
                  placeholder={esEntidad ? "ejemplo@institucion.cl" : "tu-correo@gmail.com"}
                  disabled={cargando}
                  className="w-full bg-slate-950 border border-slate-800 text-white pl-11 pr-4 py-3 rounded-xl focus:outline-none focus:border-red-600/60 focus:ring-1 focus:ring-red-600/40 transition-all font-semibold text-sm placeholder:text-slate-700"
                />
              </div>
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-400 uppercase tracking-widest ml-1">
                {esEntidad ? 'Contraseña de Acceso' : 'Contraseña'}
              </label>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center text-slate-500 group-focus-within:text-red-500 transition-colors pointer-events-none">
                  <Lock size={18} />
            ...
            >
              {cargando ? 'Procesando Registro...' : (
                <>
                  {esEntidad ? 'Inscribir Entidad de Emergencia' : 'Crear Mi Cuenta Ciudadana'}
